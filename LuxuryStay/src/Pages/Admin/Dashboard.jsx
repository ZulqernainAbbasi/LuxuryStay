    ...
    return (
        <div>
            ...
            <Title
                ...
                subTitle={
                    <>
                        ...
                        revenue—all in one place. Stay updated <br /> with real-time
            ...
            <div className='flex flex-wrap gap-4 my-8'>
                ...
                {/* Total Bookings */}
                <div className='bg-primary/5 border border-primary/10 rounded-xl flex items-center p-4 pr-8 min-w-[250px]'>
